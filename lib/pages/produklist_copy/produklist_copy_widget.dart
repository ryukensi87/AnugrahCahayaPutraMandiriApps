...
import 'produklist_copy_model.dart';
export 'produklist_copy_model.dart';

class ProduklistCopyWidget extends StatefulWidget {
  const ProduklistCopyWidget({Key? key}) : super(key: key);

  @override
  _ProduklistCopyWidgetState createState() => _ProduklistCopyWidgetState();
}

class _ProduklistCopyWidgetState extends State<ProduklistCopyWidget>
    with TickerProviderStateMixin {
  late ProduklistCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProduklistCopyModel());
