...
import 'mesin_air_model.dart';
export 'mesin_air_model.dart';

class MesinAirWidget extends StatefulWidget {
  const MesinAirWidget({Key? key}) : super(key: key);

  @override
  _MesinAirWidgetState createState() => _MesinAirWidgetState();
}

class _MesinAirWidgetState extends State<MesinAirWidget> {
  late MesinAirModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MesinAirModel());
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Berikut Gambar-gambar jenis Mesin air Minum, Mulai Dari mesin RO, sampai Mesin Cup Sealer AMDK',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                                              ...
                                                              await Navigator
                                                                ...
                                                                PageTransition(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    image: Image
                                                                        .asset(
                                                                      'assets/images/WhatsApp_Image_2022-09-18_at_19.57.31.jpeg',
                                                                      fit: BoxFit
                                                                          .contain,
                                                                    ),
                                                                    allowRotation:
                                      ...
                                      children: [
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: Text(
                                              'Mesin automatic cup sealing & filling adalah mesin air minum dalam kemasan (AMDK) dengan pengisian akurat dan penyegelan gelas cup otomatis. dan akurat presisi tinggi dengan toleransi 1% error. Ramesia kini menyediakan alat yang dapat bekerja secara otomatis memproduksi minuman gelas.',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                            ),
