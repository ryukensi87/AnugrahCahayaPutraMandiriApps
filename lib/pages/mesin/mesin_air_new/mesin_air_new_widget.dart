...
import 'mesin_air_new_model.dart';
...
class _MesinAirNewWidgetState extends State<MesinAirNewWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MesinAirNewModel());
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Image.asset(
                                                  'assets/images/6316109-removebg-preview.png',
                                                  width: 300.0,
                                                  height: 200.0,
                                                  fit: BoxFit.cover,
                                                ),
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('MesinAMDKNew');
                                },
                                child: Container(
                                  width: 100.0,
                                  height: 150.0,
