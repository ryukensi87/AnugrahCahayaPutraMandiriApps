...
import 'pemasangan_depot_new_model.dart';
...
class _PemasanganDepotNewWidgetState extends State<PemasanganDepotNewWidget> {
  late PemasanganDepotNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PemasanganDepotNewModel());
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/history2-removebg-preview.png',
                                                    width: 300.0,
                                                    height: 200.0,
                                                    fit: BoxFit.cover,
                                                  ),
