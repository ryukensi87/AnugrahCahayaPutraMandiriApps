...
class _DetailJasaServiceWidgetState extends State<DetailJasaServiceWidget> {
  late DetailJasaServiceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailJasaServiceModel());
