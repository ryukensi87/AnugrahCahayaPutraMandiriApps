...
class _DesigndepotWidgetState extends State<DesigndepotWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesigndepotModel());
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<List<DesignDepotRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<DesignDepotRecord> columnDesignDepotRecordList =
                          snapshot.data!;
                      return Column(
                        mainAxisSize: MainAxisSize.max,
                        children: List.generate(
                            columnDesignDepotRecordList.length, (columnIndex) {
                          final columnDesignDepotRecord =
                              columnDesignDepotRecordList[columnIndex];
                          return Padding(
                                    ...
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        ...
                                        'tglpemasangan': serializeParam(
                                          columnDesignDepotRecord.createdate,
                                          ParamType.DateTime,
                                        ),
                                        'dokumen1': serializeParam(
                                          columnDesignDepotRecord.gambar,
                                          ParamType.String,
                                        ),
                                      }.withoutNulls,
                                    );
