...
class _ProdukWidgetState extends State<ProdukWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProdukModel());
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<List<ListProdukRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ListProdukRecord> columnListProdukRecordList =
                          snapshot.data!;
                      return SingleChildScrollView(
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(
                              columnListProdukRecordList.length, (columnIndex) {
                            final columnListProdukRecord =
                                columnListProdukRecordList[columnIndex];
                            return Padding(
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          ...
                                          'harga': serializeParam(
                                            columnListProdukRecord.hargaProduk,
                                            ParamType.double,
                                          ),
                                          'stok': serializeParam(
                                            columnListProdukRecord.stokProduk,
                                            ParamType.int,
                                          ),
                                          'gambar': serializeParam(
                                            columnListProdukRecord.gambarProduk,
                                            ParamType.String,
                                          ),
                                        }.withoutNulls,
                                      );
